...
def s_update_users(uid:str, payload: dict, actor_id: str):
    if uid != actor_id:
...
def s_list_addresses(uid:str, actor_id: str):
    if uid != actor_id:
        raise AppError("Permission denied", 403)
...
def s_add_address(uid:str, payload: dict, actor_id: str):
    if uid != actor_id:
        raise AppError("Permission denied", 403)
...
def s_update_address(uid:str, addr_id: str, payload: dict, actor_id: str):
    if uid != actor_id:
        raise AppError("Permission denied", 403)
...
def s_delete_address(uid:str, addr_id: str, actor_id: str):
    if uid != actor_id:
        raise AppError("Permission denied", 403)
...
def s_set_default(uid:str, addr_id: str, actor_id: str):
    if uid != actor_id:
        raise AppError("Permission denied", 403)
