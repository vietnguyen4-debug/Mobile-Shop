...
def payment_public(payment):
    try:
        ...
        return {
            ...
            "provider_ref": getattr(payment, "provider_ref", None),
            "provider_rsp_code": getattr(payment, "provider_rsp_code", None),
            "provider_txn_no": getattr(payment, "provider_txn_no", None),
            "provider_bank_code": getattr(payment, "provider_bank_code", None),
            "provider_bank_tran_no": getattr(payment, "provider_bank_tran_no", None),
            "provider_card_type": getattr(payment, "provider_card_type", None),
            "provider_create_date": getattr(payment, "provider_create_date", None),
